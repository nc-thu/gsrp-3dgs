...
sard-v11 validate-camera path/to/user_supplied_tiles.csv
sard-v11 replay-camera path/to/user_supplied_tiles.csv --camera 0
sard-v11 run-experiments path/to/user_supplied_workload --out results_camera_ready
sard-v11 report results_camera_ready --out results_camera_ready/report.html
```

Reported FPS is camera-level model FPS.  Preprocess, sorting, cache,
